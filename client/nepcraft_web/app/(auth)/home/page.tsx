...
>
      ...
      {/* --- FULL COMPREHENSIVE LINKS BRAND FOOTER --- */}
      <footer className="bg-[#FFF2E5] pt-12 border-t border-[#EFE4D6]">
        <div className="px-6 lg:px-16 pb-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3 text-[#3D251E]">
              <a href="#" className="w-6 h-6 rounded-full bg-white flex items-center justify-center border border-[#EFE4D6] hover:text-[#C87A53] transition-colors">
                <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24"><path d="M9 8H7v3h2v9h4v-9h3l.5-3H13V6c0-.5.5-1 1-1h2V2h-3a4 4 0 00-4 4v2z"/></svg>
              </a>
              <a href="#" className="w-6 h-6 rounded-full bg-white flex items-center justify-center border border-[#EFE4D6] hover:text-[#C87A53] transition-colors">
                <svg className="w-3.5 h-3.5 stroke-current fill-none stroke-2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
              </a>
              <a href="#" className="w-6 h-6 rounded-full bg-white flex items-center justify-center border border-[#EFE4D6] hover:text-[#C87A53] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-[11px] text-[#654E47]">
              ...
              <li><a href="#" className="hover:text-[#C87A53]">Pashmina swals</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-[11px] text-[#654E47]">
              ...
              <li><a href="#" className="hover:text-[#C87A53]">Contacts Us</a></li>
        ...
        <div className="bg-[#3D251E] py-3 text-center text-[10px] text-white/70 tracking-wide font-medium flex items-center justify-center gap-1.5">
          <span className="inline-block border border-white/40 rounded-full w-4 h-4 text-center leading-3 text-[9px]">C</span>
